...
void validateHelp() {
  ...
  println("  diff validate -v [v1] [v2] [...]");
  println("");
  cout << termcolor::bold << "Subcommand pattern{2}" << termcolor::reset << ":" << endl;
  println("  diff validate -l [l1] [l2] [...]");
  println("");
  cout << termcolor::bold << "Subcommand pattern{3}" << termcolor::reset << ":" << endl;
  println("  diff validate -l [l1] [l2] [...] -v [v1] [v2] [...]");
  println("");
  cout << termcolor::bold << "Subcommand pattern{4}" << termcolor::reset << ":" << endl;
