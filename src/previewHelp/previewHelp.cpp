...
void previewHelp() {
  ...
  cout << termcolor::color<150, 150, 150> << "  diff preview -l [l1] [l2] [...] -d [d1] [d2] [...]" << termcolor::reset << endl;
  println();
  cout << termcolor::bold << "Subcommand pattern" << termcolor::reset << "{" << termcolor::bold << "1" << termcolor::reset << "}" << termcolor::bold << ":" << termcolor::reset << endl;
  cout << termcolor::color<150, 150, 150> << "  diff preview -l [l1] [l2] [...] -v [v1] [v2] [...] -d [d1] [d2] [...]" << termcolor::reset << endl;
  println();
