...
void lookHelp() {
  ...
  cout << termcolor::color<150, 150, 150> << "  diff look -v [v1] [v2] [...]" << termcolor::reset << endl;
  println();
  ...
  println();
  cout << termcolor::color<150, 150, 150> << "  diff look -l [l1] [l2] [...]" << termcolor::reset << endl;
  println();
  ...
  cout << termcolor::color<150, 150, 150> << "  diff look -l [l1] [l2] [...] -v [v1] [v2] [...]" << termcolor::reset << endl;
  println();
  ...
  cout << termcolor::color<150, 150, 150> << "  diff look -d [d1] [d2] [...] -l [l1] [l2] [...]" << termcolor::reset << endl;
  println();
  cout << termcolor::bold << "Subcommand pattern" << termcolor::reset << "{" << termcolor::bold << "5" << termcolor::reset << "}" << termcolor::bold << ":" << termcolor::reset << endl;
  cout << termcolor::color<150, 150, 150> << "  diff look -d [d1] [d2] [...] -v [v1] [v2] [...]" << termcolor::reset << endl;
  println();
  cout << termcolor::bold << "Subcommand pattern" << termcolor::reset << "{" << termcolor::bold << "6" << termcolor::reset << "}" << termcolor::bold << ":" << termcolor::reset << endl;
  cout << termcolor::color<150, 150, 150> << "  diff look -d [d1] [d2] [...] -l [l1] [l2] [...] -v [v1] [v2] [...]" << termcolor::reset << endl;
  println();
