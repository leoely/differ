...
TEST(Command_generate, the_result_file_can_be_generated_correctly) {
  ...
  EXPECT_STREQ(outputBuffer1.buf.data(), "[Generation] :: \xE2\x9C\x94 \"/tmp/differ/blake.md\";\n[Generation] :: \xE2\x9C\x94 \"/tmp/differ/emma.md\";\n[Generation] :: \xE2\x9C\x94 \"/tmp/differ/james.md\";\n[Generation] :: \xE2\x9C\x94 \"/tmp/differ/alice.md\";\n");
